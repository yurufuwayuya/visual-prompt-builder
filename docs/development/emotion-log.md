...
## 2025-07-23 KVネームスペースエラー

### 状況

本番デプロイしようとしたら「KV namespace 'production_image_cache_namespace_id'
is not valid」とか言われた。
...
- wrangler.tomlの本番環境設定にプレースホルダーが残ってた
- `production_image_cache_namespace_id`って明らかにプレースホルダーじゃん
- なんで気づかなかったの

### 本音

- プレースホルダーのまま設定ファイルに書くなよ
- せめてコメントで「要設定」とか書いとけ
- KVネームスペース作るの面倒だけどやるしかない
