...
export const commercialImageServices: ImageGenerationService[] = [
  ...
  },
  {
    ...
    instructions: 'テキストボックスにプロンプトを貼り付けてください',
    instructionsEn: 'Paste the prompt into the text box',
    freeInfo: '無料で数回生成可能',
    freeInfoEn: 'Free for several generations',
    commercialUse: true,
    limitations: '1日の回数制限あり',
    limitationsEn: 'Daily limit applies',
  },
];
