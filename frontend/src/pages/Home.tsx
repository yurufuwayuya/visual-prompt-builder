  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="container max-w-7xl">
        <header className="py-6 sm:py-8 lg:py-12 text-center lg:text-left">
        ...
        <main className="py-8 sm:py-12 lg:py-16">
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
            <Link to="/builder" className="group" aria-label="プロンプト作成を開始">
              <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-6 lg:p-8 shadow-sm transition-all hover:shadow-lg hover:scale-105 duration-200">
                ...
                <h2 className="mt-4 text-lg sm:text-xl font-semibold text-gray-900">新しく作成</h2>
                <p className="mt-2 text-sm sm:text-base text-gray-600">
                  カテゴリや詳細を選んで、オリジナルの画像プロンプトを作成します
                </p>
                <div className="mt-4">
                  <span className="text-primary-600 group-hover:underline">作成を開始 →</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/history" className="group" aria-label="作成履歴を確認">
              <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-6 lg:p-8 shadow-sm transition-all hover:shadow-lg hover:scale-105 duration-200">
                ...
                <h2 className="mt-4 text-lg sm:text-xl font-semibold text-gray-900">履歴を見る</h2>
                <p className="mt-2 text-sm sm:text-base text-gray-600">
                  過去に作成したプロンプトを確認・再利用できます
                </p>
                <div className="mt-4">
                  <span className="text-primary-600 group-hover:underline">履歴を確認 →</span>
                </div>
              </div>
            </Link>
          </div>
          ...
          <div className="mt-8 sm:mt-12 lg:mt-16">
            <div className="rounded-lg bg-blue-50 p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
              <h3 className="text-lg lg:text-xl font-semibold text-gray-900">使い方のヒント</h3>
