...
/**
 * セキュアロガーユーティリティ
 * センシティブデータを自動的にサニタイズし、本番環境での情報漏洩を防ぐ
 */
